    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#0a0a23] text-[#e0f7fa]">
            ...
            <form onSubmit={handleSubmit} className="bg-[#1e293b] p-10 rounded-2xl shadow-neon w-96 mt-10 animate-pop-in border border-[#00f0ff55]">
                <h2 className="text-3xl font-extrabold mb-6 text-[#00f0ff] drop-shadow-neon">Login</h2>
                ...
                <button type="submit" className="w-full bg-[#00f0ff] text-[#0f172a] py-3 rounded shadow hover:bg-pink-500 hover:text-white transition-all duration-200">Login</button>
                <div className="mt-4 text-sm text-[#94a3b8]">Don't have an account? <Link to="/register" className="text-[#00f0ff] hover:text-pink-500 transition">Register</Link></div>
            </form>
        </div>
    );
}
